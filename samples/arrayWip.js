const { Arrays, ArraysObjective, ArraysNumerical } = require("../dist/index");
...
const result1 = ArraysNumerical.sum(array1);
const result2 = ArraysObjective.groupBy(object1, "size");
const result3 = Arrays.summarize(array2);
const result4 = ArraysNumerical.max(array1);
const result5 = ArraysObjective.sortBy(object1, "size", false);
const result6 = ArraysObjective.hierarchyFromFlat(object1, "state", "near");
